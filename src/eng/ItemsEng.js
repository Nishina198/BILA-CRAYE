...
export class ItemsEng extends Component {
  render() {
      ...
      <main className='main'>
        ...
        <div class="text_new">
            <span class="left_menu">
                <span><p class="characteristics1">SORTING FOR</p><a href="/">
                ...
                <span><p class="characteristics1">SIZE</p><a href="/"><svg class="arrow" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_37_280)">
                    <path d="M11 7L6 12L1 7L1.8875 6.1125L6 10.225L10.1125 6.1125L11 7Z" fill="black"/>
                    </g>
                    <defs>
                ...
                <span><p class="characteristics1">COLOR</p><a href="/"><svg class="arrow" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_37_280)">
                    <path d="M11 7L6 12L1 7L1.8875 6.1125L6 10.225L10.1125 6.1125L11 7Z" fill="black"/>
                    </g>
                    <defs>
            ...
            <span class="serch_menu">
                    ...
                    <p id="stuff" class="characteristics">8 things</p>
