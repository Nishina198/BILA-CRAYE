        ...
        <NavLink to="/rus" id="global_text">BILA CRAYE</NavLink> 
            <div class="line"></div> 
                <div align="center" class="nav_menu"> 
                    <NavLink to="/new.rus"id='new1' class="spn_nav">НОВОЕ</NavLink>
                    <NavLink to="/tshirt.rus"id='tshirt1'class="spn_nav"> ФУТБОЛКИ</NavLink> 
                    <NavLink to="/sweatshirt.rus"id='sweatshirt1'class="spn_nav">СВИТШОТЫ</NavLink>
                    <NavLink to="/hodie.rus"id='hodie1'class="spn_nav">ХУДИ</NavLink>
                    <NavLink to="/pants.rus"id='pants1'class="spn_nav">ШТАНЫ</NavLink>
                    <NavLink to="/shoes.rus"id='backpacs1'class="spn_nav">ОБУВЬ</NavLink>
                    <NavLink to='/faq.rus' id="faq1">FAQ</NavLink>
                    <span onClick={()=> setLanguageActive(!languageActive===!registrationActive===!basketActive)} id="div_right" className="spn_nav_left">RUS</span> 
                    ...
                    <span className="spn_nav_left" id='werty'>0 UAN</span> 
        ...
        <CSSTransition in={registrationActive} timeout={200} classNames="alert" unmountOnExit>
          ...
          <div className="blk_element" id="menu" >
            ...
            <div className='div_basket'>
              ...
              <NavLink to="/shoes.rus" className='menu_links'>Рюкзаки</NavLink>
