...
export default function MainHomeUkr() {
        ...
        <NavLink to="/ukr" id="global_text">BILA CRAYE</NavLink> 
            <div class="line"></div> 
                <div align="center" class="nav_menu"> 
                    <NavLink to="/new.ukr"id='new1' class="spn_nav">НОВЕ</NavLink>
                    <NavLink to="/tshirt.ukr"id='tshirt1'class="spn_nav">ФУТБОЛКИ</NavLink> 
                    <NavLink to="/sweatshirt.ukr"id='sweatshirt1'class="spn_nav">СВІТШОТИ</NavLink>
                    <NavLink to="/hodie.ukr"id='hodie1'class="spn_nav">ХУДІ</NavLink>
                    <NavLink to="/pants.ukr"id='pants1'class="spn_nav">ШТАНИ</NavLink>
                    <NavLink to="/shoes.ukr"id='backpacs1'class="spn_nav">ВЗУТТЯ</NavLink>
                    <NavLink to='/faq.ukr' id="faq1">FAQ</NavLink>
                    <span onClick={()=> setLanguageActive(!languageActive)} id="div_right" className="spn_nav_left">UKR</span> 
            ...
            <div className='div_basket'>
              <div className='basket'>
                ...
                <div className='basket_div_text'>
                  <p className='basket_text'>ЦІНА ТОВАРІВ:</p>
                  <p className='basket_price'>0 UAN</p>
                </div>
                <div className='basket_div_text' id='indent'>
                  <p className='basket_text'>ЦІНА ДОСТАВКИ:</p>
                  <p className='basket_price'>0 UAN</p>
                </div>
                <div className='basket_div_text'>
