...
export default function HeaderUkr(props) {
  ...
  return (
    ...
    <header>
        ...
        <div class="div_top"> 
            <NavLink to="/ukr" id="global_text">BILA CRAYE</NavLink> 
            <div class="line"></div> 
                <div align="center" class="nav_menu"> 
                    <NavLink to="/new.ukr"id='new' class="spn_nav">НОВЕ</NavLink>
                    <NavLink to="/tshirt.ukr"id='tshirt'class="spn_nav">ФУТБОЛКИ</NavLink> 
                    <NavLink to="/sweatshirt.ukr"id='sweatshirt'class="spn_nav">СВІТШОТИ</NavLink>
                    <NavLink to="/hodie.ukr"id='hodie'class="spn_nav">ХУДІ</NavLink>
                    <NavLink to="/pants.ukr"id='pants'class="spn_nav">ШТАНИ</NavLink>
                    <NavLink to="/shoes.ukr"id='backpacs'class="spn_nav">ВЗУТТЯ</NavLink>
                    <NavLink to='/faq.ukr' id="faq">FAQ</NavLink>
                    <span onClick={()=> setLanguageActive(!languageActive===!registrationActive===!basketActive)} id="div_right" className="spn_nav_left">UKR</span> 
